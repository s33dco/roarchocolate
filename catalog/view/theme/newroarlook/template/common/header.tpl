...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/newroarlook/stylesheet/stylesheet.css" />
<link rel="stylesheet" type="text/css" href="catalog/view/theme/newroarlook/stylesheet/jquery.fancybox-1.3.1.css" />
...
<script type="text/javascript" src="catalog/view/theme/newroarlook/lib/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="catalog/view/theme/newroarlook/lib/jquery.easySlider1.7.js"></script>
<script type="text/javascript" src="catalog/view/theme/newroarlook/lib/jquery.fancybox-1.3.1.pack.js"></script>
<script type="text/javascript" src="catalog/view/theme/newroarlook/lib/jquery.easing-1.3.pack.js"></script>
<script type="text/javascript" src="catalog/view/theme/newroarlook/lib/jquery-custom.js"></script>
...
<div id="container">
	...
	<div id="header">
		     			<div id="fact">
            <h2>Raw, Vegan, No Sugar, No Soya, No Carob, No Salt, No Hydrongenated Fats, No Pesticides, No Gmo, Handmade &amp; Delicious</h2>
            </div> 
		<div class="holder">
            ...
            <div class="aleft">
                ...
                <div class="logo">			
					<?php if ($logo) { ?>
	      			...
	      			<?php } else { ?>
	      			<a href="<?php echo str_replace('&', '&amp;', $home); ?>">
	      			<img src="<?php echo 'catalog/view/theme/newroarimage/images/logo.png'; ?>" alt="<?php echo $store; ?>" />
	      			</a>
	      			<?php } ?>
      			</div>
                ...
                <div id="chocbuttons">
					<ul>
						...
						<?php echo $text_home; ?></a>
			      		...
			      		<?php if (!$logged) { ?>
			      		<li>
			     		<a class="rounded" href="<?php echo str_replace('&', '&amp;', $login); ?>" id="tab_login">
			     		<?php echo $text_login; ?></a>
			     		</li>
			      		<?php } else { ?>
			      		<li>     		
			      		<a class="rounded" href="<?php echo str_replace('&', '&amp;', $logout); ?>" id="tab_logout">
		...
		<!---->
                                ...
                                <a href="<?php echo str_replace('&', '&amp;', $breadcrumb['href']); ?>" title="<?php echo $breadcrumb['text']; ?>">
